...
remove console ANSI formatting before detecting terminal completion. The final matrix used a
newly prepared payload containing both service corrections and fresh evidence paths.
